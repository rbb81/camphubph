...
- **Nature-inspired palette:** teal/green as the primary accent (forest, foliage), warm amber/coral as a secondary accent (campfire, sunset), neutral grays for structure — consistent across all screens above.
